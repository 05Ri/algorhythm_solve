package baekjoon.BOJ_2579_계단_오르기;
...
public class Solution_2차원_방문_배열_실패_1 {
	 ...
	 * @return 가장 큰 합
	 */
	public static void ggangchong(int idx, int isDouble, int isDoublePrev, int idxPrev) {

//		System.out.println(Arrays.deepToString(sumMax));
//		System.out.println(idx + " " + isDouble + " " + idxPrev);
		...
		if (isDouble != 1)
			ggangchong(idx + 1, 1, isDouble, idx);
		
		// 두 칸 앞으로 가서 dfs 탐색한다.
		ggangchong(idx + 2, 0, isDouble, idx);
